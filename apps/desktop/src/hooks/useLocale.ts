...
const zh: Record<string, string> = {
  ...
  "publish.toastAutoMergeFailed": "PR 已创建，但自动合并失败：{error}",
  ...
  "workspace.add.desc": "工作区就是一个 Git 仓库。选择一个你有权限访问的仓库。",
  "workspace.add.fromGithub": "从 GitHub 添加",
  "workspace.add.manual": "手动 / 本地",
  "workspace.add.searchPlaceholder": "搜索你的 GitHub 仓库…",
  "workspace.add.noMatches": "没有匹配的仓库。",
  "workspace.add.signInRequired": "从账户菜单登录 GitHub 后即可浏览仓库。",
  ...
  "workspace.add.pathPlaceholder": "acme/team-skills、~/code/skills 或 demo",
...
const en: Record<string, string> = {
  ...
  "publish.toastCreated": "{title} #{number}",
  "publish.toastAutoMergeFailed": "PR created, but auto-merge failed: {error}",
  ...
  "sync.prAutoMerged": "PR auto-merged",
  ...
  "workspace.add.desc": "A workspace is just a Git repository. Pick one you have access to.",
  "workspace.add.fromGithub": "From GitHub",
  "workspace.add.manual": "Manual / Local",
  "workspace.add.searchPlaceholder": "Search your GitHub repos…",
  "workspace.add.noMatches": "No matching repos.",
  "workspace.add.signInRequired": "Sign in to GitHub from the account menu to browse repos.",
  ...
  "workspace.add.pathPlaceholder": "acme/team-skills, ~/code/skills, or demo",
