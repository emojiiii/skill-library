...
use skill_library_core::{RiskLevel, WorkspaceRef};
use skill_library_manifest::{effective_risk, parse_skill_dir, SkillManifest};
use std::fs;
...
pub fn build_publish_request(
    ...
    let branch_name = format!(
        ...
        package.manifest.id, short_hash
    );
    let title = format!(
        "Import skill {} v{}",
