...
import { Download, GitPullRequestArrow, Package, PackageOpen, RefreshCw, RotateCcw, Trash2 } from "lucide-react";
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            ...
            {skill.isModified ? <Pill tone="warning">{t("local.modified")}</Pill> : null}
          </div>
          {skill.description ? (
