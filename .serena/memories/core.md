...
- Workdir: `/Users/cyk/Documents/emojiiii/Team AI Hub`.
- Always prefix shell commands with `rtk`; repo instructions come from `/Users/cyk/.codex/RTK.md`.
- Product: Team AI Hub, a Git-provider-backed workflow layer for team AI Skills.
...
- Current durable completion gate from README/docs: local checks can pass, but full MVP is not complete until real GitHub demo evidence is recorded and verified against a prepared `team-ai-hub-demo-skills` repo.