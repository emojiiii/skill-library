...
- Rust workspace, edition 2021, version `0.1.0`; crates: `skill-library-core`, `skill-library-manifest`, `skill-library-provider`, `skill-library-provider-github`, `skill-library-installer`, `skill-library-sync`, `skill-library-publish`, `skill-library-cli`.
