...
- Full MVP completion requires real-provider GitHub demo execution plus required screenshots and `rtk pnpm demo:verify-evidence .teamai-demo-evidence/<timestamp>` passing.